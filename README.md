...
This repository is a fresh public implementation derived from the working version. Polishing to reference-implementation quality is in progress: primitive consolidation, action-time injection, texture preservation on misses, counterfactual capture, active failure-shape curation, recurrence detection.
